...
export default function ContentFormatXB (props) {
    ...
    <div className="sticky-top">
      ...
      <div className="row">
        ...
        <div className="col p-0 border-start border-end">
          <div className="d-flex flex-column" style={{height:'100vh', overflowY:'hidden'}}>
            ...
            <div className="mt-auto p-3 border-top align-self-stretch">
              {props.main.foot}
            </div>
          </div>
